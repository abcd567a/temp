...
echo -e "\e[95m(2) In your browser, go to http://$(ip route | grep -m1 -o -P 'src \K[0-9,.]*')/gain2.php \e[39m"
echo ""
...
echo -e "\e[95m(4) Go to http://$(ip route | grep -m1 -o -P 'src \K[0-9,.]*')/skyaware2/ \e[39m"
echo ""
