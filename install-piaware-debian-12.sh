...
echo -e "\e[39m    https://flightaware.com/adsb/stats/user/ \e[39m"
echo ""
...
echo ""
echo -e "\e[39mIf you dont already have a feeder-id, \e[39m"
echo -e "\e[39mplease go to Flightaware Claim page while loggedin \e[39m"
echo -e "\e[39m    https://flightaware.com/adsb/piaware/claim \e[39m"
echo ""
echo -e "\e[35mDue to cx_Freeze issue, the piaware source code at\e[39m"
echo -e "\e[35mFlightaware fails to build on Bookworm.... \e[39m"
echo -e "\e[35mThis piaware has been built using source-code from:\e[39m"
echo -e "\e[39m    https://github.com/WhoAmI0501/piaware_builder\e[39m"
echo -e "\e[35mand using mlat-client source-code from:\e[39m"
echo -e "\e[39m    https://github.com/wiedehopf/mlat-client\e[39m"
echo -e "\e[31mMLAT will be ENABLED .... \e[39m"
