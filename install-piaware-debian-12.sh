...
echo -e "\e[39mIf please go to Flightaware Claim page while loggedin \e[39m"
echo -e "\e[1;39m    https://flightaware.com/adsb/piaware/claim \e[39m"
echo ""
echo -e "\e[1;35mDue to cx_Freeze issue, the piaware source code at\e[39m"
echo -e "\e[1;35mFlightaware fails to build on Bookworm.... \e[39m"
