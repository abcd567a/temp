...
echo -e "\e[32m=======================\e[39m"
echo " "
echo -e "\e[33m  1. Copy coaa.h to folder /usr/share/ppup1090/ \e[39m"
echo " "
echo -e "\e[33m  2. Copy compiled binary ppup1090 to folder /usr/share/ppup1090/ \e[39m"
echo -e "\e[95m     IMPORTANT: Make sure the binary is named ppup1090 \e[39m"
echo " "
echo -e "\e[33m  3. Make the copied binary executable by following command: \e[39m"
echo -e "\e[39m     sudo chmod +x /usr/share/ppup1090/ppup1090 \e[39m"
echo " "
