...
ExecStart=/usr/share/ppup1090/ppup1090 --quiet
...
echo -e "\e[32m=======================\e[39m"
echo " "
echo -e "\e[33mRestart ppup1090 by following command:\e[39m"
echo -e "\e[39m     sudo systemctl restart ppup1090 \e[39m"
echo " "

echo -e "\e[32mTo see status\e[39m sudo systemctl status ppup1090"
echo -e "\e[32mTo restart\e[39m    sudo systemctl restart ppup1090"
echo -e "\e[32mTo stop\e[39m       sudo systemctl stop ppup1090"
